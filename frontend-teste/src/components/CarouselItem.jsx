export default function CarouselItem({ description, price, image }) {
  return (
    <div className="bg-[#1E1E1E] p-2 cursor-pointer w-[17%] flex-none rounded-md hover:shadow-[0px_0px_15px_rgba(255,0,0,1)] transition-all duration-200">
